...
def get_wall_gcp_data():
    ...
    return pd.DataFrame({
        ...
        "Zone 4 Negative":
        [-1.1, -1.046838103, -0.976561897, -0.9234, -0.870238103, -0.799961897, -0.8],

        "Zone 5 Negative":
        [-1.4, -1.293676206, -1.153123794, -1.0468, -0.940476206, -0.799923794, -0.8],

        "Zones 4&5 Positive":
        [1.00, 0.95, 0.88, 0.82, 0.77, 0.70, 0.70]
